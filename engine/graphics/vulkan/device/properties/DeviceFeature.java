...
public enum DeviceFeature {
    ...
    public static List<DeviceFeature> ofVk(VkPhysicalDeviceFeatures vkFeatures) {
    ...
    public static VkPhysicalDeviceFeatures toVk(Collection<DeviceFeature> features) {
        VkPhysicalDeviceFeatures vkFeatures = VkPhysicalDeviceFeatures.malloc(MemoryContext.getStack());
