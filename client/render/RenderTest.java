    ...
    private static class HelloTriangleApplication {
        ...
        private void createGraphicsPipeline() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                byte[] vertShaderSPIRV = Files.readAllBytes(Path.of("shaders/base.vert.spv"));
                byte[] fragShaderSPIRV = Files.readAllBytes(Path.of("shaders/base.frag.spv"));

                long vertShaderModule = createShaderModule(stack.bytes(vertShaderSPIRV));
                long fragShaderModule = createShaderModule(stack.bytes(fragShaderSPIRV));
